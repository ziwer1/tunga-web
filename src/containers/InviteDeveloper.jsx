...
class InviteDeveloper extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.AuthActions.invite({first_name, last_name, email, type, resend: this.state.resend});
        return;
    }
                ...
                <div className="form-wrapper">
                    <form onSubmit={this.handleSubmit.bind(this)} name="invite" role="form" ref="invite_form">
                        ...
                        {(Auth.error.user && Auth.error.invite.type)?
                            (<FieldError message={Auth.error.invite.type}/>):null}
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            <div className="checkbox">
                                <label className="control-label">
                                    <input type="checkbox" ref="resend"
                                           checked={this.state.resend}
                                           onChange={this.onResendChange.bind(this)}/>
