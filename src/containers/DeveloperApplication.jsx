            ...
            <div>
                ...
                {isHiring?(
                    ...
                    <div className="announcement">
                        <p>We are not accepting new applications from developers at the moment.</p>
                        <p>
                            Please follow us on   <i className="fa fa-twitter twitter"/> Twitter <a className="twitter" href="https://twitter.com/tunga_io" target="_blank">@tunga_io</a> to get notified when opportunities for new developers open up.
                        </p>
                    </div>
                )}
