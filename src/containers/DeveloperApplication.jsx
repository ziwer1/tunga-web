      ...
      <div>
        ...
        {isHiring
          ? <div className="form-elements-container">
              <form
                ...
                {Auth.error.apply && Auth.error.apply.last_name
                  ? <FieldError message={Auth.error.apply.last_name} />
                  : null}
                <div className="form-group">
                  <input
                    type="text"
                ...
                {Auth.error.apply && Auth.error.apply.phone_number
                  ? <FieldError message={Auth.error.apply.phone_number} />
                  : null}
                <div className="form-group">
                  <input
                    type="text"
                ...
                {Auth.error.update && Auth.error.update.experience
                  ? <FieldError message={Auth.error.update.experience} />
                  : null}
                <div className="form-group">
                ...
                {Auth.error.update && Auth.error.update.discovery_story
                  ? <FieldError message={Auth.error.update.discovery_story} />
                  : null}
                <div className="form-group">
                  <textarea
                    id="discovery-story"
          ...
          : <div className="announcement">
              <p>
                We are not accepting new applications from developers at the
                moment.
              </p>
              <p>
                Please follow us on <i className="fa fa-twitter twitter" />{' '}
                Twitter{' '}
                <a
                  className="twitter"
                ...
                to get notified when opportunities for new developers open up.
              </p>
            </div>}
      </div>
    );
