...
export default class GenericListContainer extends GenericContainer {
    ...
    constructor(props) {
        super(props);
        this.state = {selection_key: props.selectionKey || randomstring.generate(), prev_key: null};
    }
    ...
    componentDidUpdate(prevProps, prevState) {
        if(this.props.selectionKey && this.props.selectionKey != prevProps.selectionKey) {
            this.setState({selection_key: this.props.selectionKey, prev_key: prevProps.selectionKey});
        }
