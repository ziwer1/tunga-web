            ...
            <div className="form-wrapper">
                <form onSubmit={this.handleSubmit.bind(this)} name="rate" role="form" ref="rate_form">
                    ...
                    <div className="card">
                        ...
                        developers. You can rate a developer on three scales. Please take 5 seconds of your to rate our
                        Developers. Thank you in advance
                    </div>
                            ...
                            <div key={criteria.id} style={{margin: '15px 0'}}>
                                ...
                                <div className="rating large">
                                    <Rating start={0} stop={10} step={2} fractions={2}
                                            initialRate={this.state.ratings_map?this.state.ratings_map[criteria.id]:0}
