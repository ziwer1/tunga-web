...
export default class Docs extends React.Component {
    ...
    renderfilteredDocs(type){
        ...
        let filtered_docs= this.filterDocumentsByType(this.props.project.documents, type)
        let list = []
                ...
                <Container>
                    <Row className="documents-row-bottom-margin">
                        <Col>
                            ...
                            <DocumentPicker showSelected={false} documentType='estimate' onChange={(docs) => { this.onChangeValue('estimate', docs)}}/>
                        </Col>
                    </Row>
                    <Row className="documents-row-bottom-margin">
                        <Col>
                            ...
                            <DocumentPicker showSelected={false} documentType='proposal' onChange={(docs) => { this.onChangeValue('proposal', docs)}}/>
                        </Col>
                    </Row>
                    <Row className="documents-row-bottom-margin">
                        <Col>
                            ...
                            <DocumentPicker showSelected={false} documentType='requirements' onChange={(docs) => { this.onChangeValue('requirements', docs)}}/>
                        </Col>
                    </Row>
                    <Row className="documents-row-bottom-margin">
                        <Col>
                            ...
                            <DocumentPicker showSelected={false} documentType='other' onChange={(docs) => { this.onChangeValue('other', docs)}}/>
                        </Col>
                    </Row>
                </Container>
            </div>
