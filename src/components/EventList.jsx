...
export default class EventList extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            !_.isEqual(this.state.milestones, nextProps.Milestone.list.milestones) && 
            !_.isEqual(nextProps.Milestone.list.milestones, undefined)
        ) {

            var old_milestones = this.state.milestones;
            var new_milestones = old_milestones.concat(serializeMilestones(_.values(nextProps.Milestone.list.milestones)));
