        ...
        {Task.detail.applications.isSaved
          ...
          : <form
              ...
              Task.detail.applications.error.create.pitch
                ? <FieldError
                    message={Task.detail.applications.error.create.pitch}
                  />
                : null}
              ...
              Task.detail.applications.error.create.hours_needed
                ? <FieldError
                    message={Task.detail.applications.error.create.hours_needed}
                  />
                : null}
              {Task.detail.applications.error.update &&
              Task.detail.applications.error.update.hours_needed
                ? <FieldError
                    message={Task.detail.applications.error.update.hours_needed}
                  />
                : null}
              <div className="form-group">
                <label className="control-label">
                ...
                {task.is_task
                  ? <div>
                      ...
                      {task.fee
                        ? <div>
                            Client's proposal: €{parseNumber(task.amount.developer)}
                          </div>
                        : null}
              ...
              Task.detail.applications.error.create.deliver_at
                ? <FieldError
                    message={Task.detail.applications.error.create.deliver_at}
                  />
                : null}
              <div className="form-group">
              ...
              {task.update_interval && task.update_interval_units
                ? <div className="form-group">
                    <div>
                      Update schedule: {task.update_schedule_display}
                    </div>
              ...
              Task.detail.applications.error.create.remarks
                ? <FieldError
                    message={Task.detail.applications.error.create.remarks}
                  />
                : null}
              <div className="form-group">
                <label className="control-label">
