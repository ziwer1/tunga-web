            ...
            <div>
                ...
                {Support.Section.list.isFetching?
                    ...
                    (<div>
                        ...
                        <LoadMore url={Support.Section.list.next} callback={SupportActions.listMoreSupportSections} loading={Support.Section.list.isFetchingMore}/>
                        {Support.Section.list.sections.length?null:(
                        <div className="alert alert-info">No sections to display</div>
                            )}
                    </div>)
                    }
            </div>
