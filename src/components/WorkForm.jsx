...
export default class WorkForm extends React.Component {
    ...
    handleSubmit(e) {
        ...
        const work = this.props.work || {};
        const work_info = {company, details, position, start_year, start_month, end_year, end_month};
        if(work.id) {
    ...
    render() {
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit} name="work" role="form" ref="work_form">
                    <FormStatus loading={Profile.isSaving.work}
                                success={Profile.isSaved.work}
                                message={'Work experience updated successfully'}
                                error={Profile.error.work}/>

                    {(Profile.error.work && Profile.error.work.start_year)?
                        (<FieldError message={Profile.error.work.start_year}/>):null}
                    {(Profile.error.work && Profile.error.work.start_month)?
                        (<FieldError message={Profile.error.work.start_month}/>):null}
                    <div className="form-group">
                        <label className="control-label">Start Date *</label>
                        <div className="row">
                            <div className="col-xs-6 col-md-3">
                                <select type="text" className="form-control" ref="start_month" defaultValue={work.start_month} required>
                            ...
                            <div className="col-xs-6 col-md-3">
                                <select type="text" className="form-control" ref="start_year" defaultValue={work.start_year} required>
                                    {years.map((year) => {
                    ...
                    {(Profile.error.work && Profile.error.work.end_year)?
                        (<FieldError message={Profile.error.work.end_year}/>):null}
                    {(Profile.error.work && Profile.error.work.end_month)?
                        (<FieldError message={Profile.error.work.end_month}/>):null}
                    <div className="form-group">
                        <label className="control-label">End Date</label>
                        <div className="row">
                            <div className="col-xs-6 col-md-3">
                                <select type="text" className="form-control" ref="end_month" defaultValue={work.end_month}>
                            ...
                            <div className="col-xs-6 col-md-3">
                                <select type="text" className="form-control" ref="end_year" defaultValue={work.end_year}>
                    ...
                    {(Profile.error.work && Profile.error.work.company)?
                        (<FieldError message={Profile.error.work.company}/>):null}
                    <div className="form-group">
                        <label className="control-label">Company *</label>
                        <div><input type="text" className="form-control" ref="company" required placeholder="Company" defaultValue={work.company}/></div>
                    </div>

                    {(Profile.error.work && Profile.error.work.position)?
                        (<FieldError message={Profile.error.work.position}/>):null}
                    <div className="form-group">
                        <label className="control-label">Position *</label>
                        <div><input type="text" className="form-control" ref="position" required placeholder="Position" defaultValue={work.position}/></div>
                    </div>
