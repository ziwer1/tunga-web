...
export default class PasswordChangeForm extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if(this.props.Profile.isSaved.security && !prevProps.Profile.isSaved.security) {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit} name="password" role="form" ref="password_form">
                    <FormStatus loading={Profile.isSaving.security}
                    ...
                    <div className="form-group">
                        ...
                        <div><input type="password" className="form-control" ref="old_password" required placeholder="Current Password"/></div>
                    </div>
