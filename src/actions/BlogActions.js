  ...
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          createBlogFailed(error.response ? error.response.data : null),
        );
      });
  };
}
...
export function retrieveBlog(id) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          retrieveBlogFailed(error.response ? error.response.data : null),
        );
      });
  };
}
...
export function updateBlog(id, blog) {
  ...
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          updateBlogFailed(error.response ? error.response.data : null),
        );
      });
  };
}
...
export function deleteBlog(id) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          deleteBlogFailed(error.response ? error.response.data : null),
        );
      });
  };
}
