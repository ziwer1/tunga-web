  ...
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          createQuoteFailed(error.response ? error.response.data : null)
        );
      });
  };
}
...
export function retrieveQuote(id) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          retrieveQuoteFailed(error.response ? error.response.data : null)
        );
      });
  };
}
...
export function updateQuote(id, data) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          updateQuoteFailed(error.response ? error.response.data : null)
        );
      });
  };
}
...
export function deleteQuote(id) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          deleteQuoteFailed(error.response ? error.response.data : null)
        );
      });
  };
}
