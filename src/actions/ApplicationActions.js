...
export const LIST_MORE_APPLICATIONS_START = 'LIST_MORE_APPLICATIONS_START';
export const LIST_MORE_APPLICATIONS_SUCCESS = 'LIST_MORE_APPLICATIONS_SUCCESS';
export const LIST_MORE_APPLICATIONS_FAILED = 'LIST_MORE_APPLICATIONS_FAILED';
