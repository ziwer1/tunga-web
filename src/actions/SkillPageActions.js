...
export function listSkillPages(filter, selection, prev_selection) {
  return dispatch => {
    ...
    axios
      ...
      .then(function(response) {
        dispatch(listSkillPagesSuccess(response.data, filter, selection));
      })
      .catch(function(error) {
        dispatch(
...
export function retrieveSkillPage(id, editToken) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          retrieveSkillPageFailed(error.response ? error.response.data : null),
        );
      });
  };
}
...
export function deleteSkillPage(id) {
  return dispatch => {
    ...
    axios
      ...
      .catch(function(error) {
        dispatch(
          deleteSkillPageFailed(error.response ? error.response.data : null),
        );
      });
  };
}
