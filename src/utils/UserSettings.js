...
export const JOIN_TEAM_REQUEST_RESPONSE_EMAIL = 'join_team_request_response_email';
...
export const TASK_APPLICATION_RESPONSE_EMAIL = 'task_application_response_email';
...
export const TASK_PROGRESS_REPORT_REMINDER_EMAIL = 'task_progress_report_reminder_email';
...
export const SWITCH_SETTINGS = [
    ...
    // owner
    {name: TEAM_INVITATION_RESPONSE_EMAIL, label: 'Response to team invitation', buttons: notify_buttons},
    //dev
    {name: FRIEND_REQUEST_RESPONSE_EMAIL, label: 'Response to friend request', buttons: notify_buttons},
    {name: JOIN_TEAM_REQUEST_RESPONSE_EMAIL, label: 'Response to join team request', buttons: notify_buttons},
    {name: NEW_TEAM_INVITATION_EMAIL, label: 'Invitation to join a team', buttons: notify_buttons},
    // dev end
    ...
    {name: TASK_APPLICATION_RESPONSE_EMAIL, label: 'Task application accepted or rejected', buttons: notify_buttons}, //owner
    {name: NEW_TASK_INVITATION_EMAIL, label: 'Invitation to a task', buttons: notify_buttons}, //owner
    {name: TASK_INVITATION_RESPONSE_EMAIL, label: 'Task invitation accepted or rejected', buttons: notify_buttons}, //owner
    {name: TASK_PROGRESS_REPORT_REMINDER_EMAIL, label: 'Reminders about upcoming reports for milestones and scheduled updates', buttons: notify_buttons},
    {name: TASK_ACTIVITY_UPDATE_EMAIL, label: 'Task activity updates', buttons: notify_buttons},
