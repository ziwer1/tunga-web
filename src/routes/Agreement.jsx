  ...
  renderHeaderContent() {
    return (
      <div className="content">
        ...
        <p>
          Welcome to the Tunga User Agreement. Tunga is an online platform that
          connects African software programmers to tech businesses and software
          projects from all over the world.
        </p>

        <p>
          This User Agreement contains the terms & conditions that apply to the
          usage of the Tunga Website and Services. Agreeing to these terms &
          conditions constitutes a lawful agreement between you and Tunga.
        </p>

        <p>
          Tunga can modify this User Agreement as it sees fit. The changed
          version of this User Agreement will be applicable from the moment the
          (changed) User Agreement is publicized on the Website. If a User does
          not accept the changed terms of use, he/she has to notify Tunga in
          writing within one week after publication of the changed terms of use.
        </p>
        ...
        <p>
          <strong>Account:</strong> the account you open by signing up to the
          Tunga Website
        </p>

        <p>
          <strong>Buyer:</strong> User that purchases Services at the Tunga
          Website
        </p>

        <p>
          <strong>Confidential Information:</strong> details regarding the
          Services, including, without limitation any information regarding the
          any software code, the Service Contract, or the Buyer’s business
        </p>

        <p>
          <strong>Seller:</strong> User that offers Services at the Tunga
          Website
        </p>

        <p>
          <strong>Inactive Account:</strong> an Account which was not logged
          into by the User for 6 months or more
        </p>

        <p>
          <strong>Intellectual Property:</strong> all tangible and intangible
          results produced under the Services, including but not limited to
          (software) designs, specifications, code and applications
        </p>

        <p>
          <strong>Project:</strong> Service that requires more than 50 hours of
          work from a Seller
        </p>
        ...
        <p>
          <strong>Services:</strong> All services provided by Sellers as
          specified in the Project or Task section on the Website
        </p>

        <p>
          <strong>Task:</strong> Service that requires 50 hours or less work
          from a Seller
        </p>

        <p>
          <strong>Tunga:</strong> Tunga BV, registered at Ms van Riemsdijkweg 57
          in Amsterdam, The Netherlands (Chamber of Commerce nr: 67015679)
        </p>

        <p>
          <strong>User (also referred to as ‘you’):</strong> anyone visiting
          and/or using the Tunga Website
        </p>

        <p>
          <strong>Website:</strong> the website operated by Tunga, which is
          hosted at https://www.tunga.io, and all the services, tools and
          applications offered there
        </p>

        <h3>1. THE TUNGA ACCOUNT</h3>

        <p>
          1.1 Tunga facilitates transactions between Sellers and Buyers in 4
          ways: 1) by providing the infrastructure to match Buyers and Sellers,
          2) by providing the infrastructure for Buyers and Sellers to enter
          into Service Contracts, and 3) by providing the infrastructure for
          Buyers and Sellers to monitor and execute Project and Tasks, and 4) by
          providing the infrastructure for Buyers and Sellers to settle the
          Service Contract in terms of payments and invoicing.
        </p>

        <p>
          1.2 Only registered Users – those who have an Account at the Website –
          may use Tunga Services. Creating an Account at Tunga is free of
          charge.
        </p>

        <p>
          1.3 You cannot use Tunga if you are 1) legally not allowed to enter
          into contracts by the laws governing your country of residence, 2)
          under the age of 16, 3) have been suspended as a User by Tunga.
        </p>

        <p>
          1.4 The User is obliged to enter only valid, accurate and true
          information into User’s Tunga Account.
        </p>

        <p>
          1.5 In case the User’s account is linked on the Website to a legally
          registered company, the User declares to have all necessary power of
          attorney to use a Tunga Account on behalf of this legally registered
          company.
        </p>

        <p>
          1.6 Although User can link a business or organization to the User’s
          Account, User acknowledges that this User Agreement is nevertheless
          always a contract with the User as a private person and User is fully
          responsible as an individual for anything relating to User’s Account.
        </p>

        <p>
          1.7 The User is responsible for maintaining the secrecy of his/her
          account information, including username and password. In the event of
          misuse or suspected misuse of his/her account, the User must
          immediately notify Tunga.
        </p>

        <p>
          1.8 The User is not entitled to perform any actions that would
          interfere with the proper working of the Website and the Services.
        </p>

        <h3>2. SERVICE CONTRACTS</h3>

        <p>
          2.1 Upon awarding a Task or Project by the Buyer on the Website and
          accepting a Task or Project by the Seller on the Website, the Buyer
          and Seller enter into a Service Contract. Under this Service Contract
          the Buyer agrees to purchase and the Seller agrees to deliver the
          Services relating to this Project or Task.
        </p>

        <p>
          2.2 The Services will be delivered in accordance with the
          specifications in the Service Contract and on or before the delivery
          date agreed herein.
        </p>

        <p>
          2.3 If the Services as delivered are not in line with the Service
          Contract, the Buyer shall within 7 days of the delivery date notify
          the Seller in writing (by e-mail) of the ways in which it does not
          conform with the Service Contract. The Seller agrees that upon
          receiving such notice, it shall make reasonable efforts to correct any
          non-conformity.
        </p>

        <p>
          2.4 The Buyer shall provide to the Seller written notice of its
          finding that the Services conform to the Service Contract within 7
          days of the Delivery Date unless it finds that the Services do not
          conform to the Service Contract.
        </p>

        <p>
          2.5 You are solely responsible for ensuring that you comply with your
        ...
        <p>
          2.6 If another User breaches any obligation to you, you are solely
        ...
        <p>
          2.7 Each User acknowledges and agrees that the relationship between
          ...
          or an employer-employee relationship between Freelancer and the User.
        </p>

        <p>
          2.8 Users are themselves solely responsible for complying with the
          obligations under this Service Contract, including with obligations
          relating to any applicable local or international laws and
          regulations.
        </p>

        <p>
          2.9 Unless agreed otherwise, the Users acknowledge and agree that the
          Buyer will hold all Intellectual Property rights of the Services
          including, but not limited to, copyright and trademark rights. The
          Seller agrees not to claim any such ownership in the Services’
          Intellectual Property at any time prior to or after the completion and
          delivery of the Services to the Buyer.
        </p>

        <p>
          2.10 The Seller shall not disclose to any third party the business of
          the Buyer, details regarding the Services, including, without
          limitation any information regarding the any software code, the
          Service Contract, or the Buyer’s business (the “Confidential
          Information”), make copies of any Confidential Information or any
          content based on the concepts contained within the Confidential
          Information for personal use or for distribution unless requested to
          do so by the Buyer, or use Confidential Information other than solely
          for the benefit of the Buyer.
        </p>

        <p>
          2.11 Depending on the exact terms of the Service Contract, Tunga
          charges a fee for the use of the platform. Our fees and charges may
          change over time and can be subject to a special promotion or
          temporary campaign, or differ depending on specific project
          circumstances. Upon entering into the Service Contract you agree with
          our fees and charges as applicable to that particular Service
          Contract. Unless otherwise stated, all amounts mentioned on our
          Website are in United States Dollars.
        </p>

        <p>
          2.12 Users are themselves responsible for reporting and paying any
          taxes, including any income, goods and services or value added taxes,
          which may be applicable depending on the jurisdiction of the services
          provided.
        </p>

        <p>
          2.13 The User agrees that upon request of the Buyer, Tunga generates
          an invoice for the Services delivered on behalf of the Seller. These
          invoices can be found in the Tunga Account. Any international and/or
          domestic and/or local taxes will be excluded from this invoice. Any
          tax returns and/or tax assessment will be for the sole administrative
          accuracy, responsibility and risk of the User.
        </p>

        <p>
          2.14 To generate the invoice Tunga uses the Project or Task
          information that relates to the Service Contract, as well as the
          company data in the Tunga Account of the User. The User is fully
          responsible for the correctness of the Project or Task information and
          the company details in the Tunga Account.
        </p>

        <p>
          2.15 Although we do our best to generate invoices that comply with all
          relevant local and international laws and regulations, it is up to
          Users to assure the correctness of the invoice and to inform us if and
          when this is not the case.
        </p>

        <p>
          2.16 If the Sellers account information is incomplete, he cannot
          receive a payment. If the Buyers account information is incomplete, he
          cannot receive an invoice.
        </p>

        <p>
          2.17 Users acknowledge and agree that we may in our sole discretion,
          ...
          rights, powers and privileges as our agent or in their own name. In no
          event shall we be liable to any User for any loss, damage or liability
          resulting from the payment administration agent's negligence and/or
        ...
        <p>
          ...
          defamatory, invasive of privacy, vulgar, obscene, profane or which may
          harass or cause distress or inconvenience to, or incite hatred of, any
          person.
        </p>
        ...
        <p>
          ...
          course of using the Tunga Website and Tunga and Seller Services.
        </p>
        ...
        <p>
          ...
          advance, if possible. Tunga is never liable for claims as a result of
          unavailability of the Tunga Account, the Services or the Website.
        </p>
        ...
        <p>
          ...
          rights, unless otherwise explicitly indicated by Tunga.
        </p>
        ...
        <p>
          ...
          the explicit exclusion of every other court.
        </p>
