        ...
        return (
            <div id="friends-header">
                ...
                <p id="sub-heading">
                    ...
                    lead that becomes a paying customer we donate 5% up
                    <br />to EUR 1,000 to
                    <a href="http://bitsacademy.org/">Bits Academy</a>, a
                ...
                <div className="content">
                        ...
                        <div className="col-md-12 no-padding">
                            ...
                            <div className="col-md-4">
                                <div className="first-content-box">
                                    ...
                                    <div className="text-container">
                                        <p>
                                            <b>Startups and innovation teams</b>{' '}
                            ...
                            <div className="col-md-8 ">
                                <div className="middle-content-box">
                                    <p>
                                        ...
                                        bart@tunga.io in cc. To make it easy for
                    ...
                    <section className="container">
                        <div className="col-md-12 no-padding">
                            <div className="col-md-8 ">
                                <div
                                    className={`col-md-12  rectangle-form ${
