                ...
                <div className="col-sm-5 skill-page sub_header ">
                    {isSkillPage && skill_page.welcome_sub_header ? (
                        ...
                        <p>
                            ...
                            {this.getDLPDesc() || 'developers'} from Africa work
                            on your software project in a productive, friendly
                            and worthwhile way.
                        </p>
                    )}
                </div>
                <div className="col-sm-12">{/*clearing grid hack*/}</div>
                <div className="col-sm-5">
                    <div>
                        <a
                            className="btn skill-page schedule_call"
                            href="/call/">
                            Schedule a call
                        </a>
                    </div>
                ...
                {isRetrieving ? (
                    ...
                    <div>
                                ...
                                <div className="container">
                                    ...
                                    {skill_page.pitch_image ? (
                                        <div className="col-sm-3">
                                            <img
                                                src={skill_page.pitch_image.url}
                                                alt="tunga_developer.jpg"
                                                style={{
                                                    width: '300px',
                                                    height: '300px',
                                                }}
                        ...
                        {skill_page.profiles && skill_page.profiles.length ? (
                            <section
                                id="skill-profiles"
                                className="skill-page skill-profile">
                        ...
                        <section
                            id="story"
                            className="skill-page story_interlude_one_image">
                            <div className="container">
                                <div
                                    className="section-heading text-center"
                                    dangerouslySetInnerHTML={{
                                        __html: nl_to_br(
                                            skill_page.story_header,
                                        ),
                                    }}
                                />
                                <div
                            ...
                            <div
                                ...
                                className="skill-page story_interlude"
                                style={
                                    ...
                                    <div className="col-md-12 skill-page-contact-us">
                                        <div className="col-md-5">
                                            ...
                                            <p>
                                                ...
                                                <br />
                                                The Collab, Wibautstraat 131,
                                                1091 GL Amsterdam, The
                                                Netherlands
                                            </p>
                                            <br />
                                            <p>
