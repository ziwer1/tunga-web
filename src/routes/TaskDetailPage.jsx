...
import { isAdmin, isDeveloper, isProjectManager, getUser, isAuthenticated } from '../utils/auth';
...
export default class TaskDetailPage extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if(isAuthenticated() && this.props.Task.detail.isSaved && !prevProps.Task.detail.isSaved && this.props.Task.detail.task.id != this.props.params.taskId) {
